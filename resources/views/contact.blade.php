...
<body>
    ...
    <!-- Header Banner -->
    <div class="banner-header section-padding back-position-center valign bg-img bg-fixed" data-overlay-dark="5" data-background="img/pexels-aleksandar-pasaric-2115367.jpg">
        <div class="container">
            <div class="row">
                    ...
                    <div class="sidebar">
                        <div class="right-sidebar">
                            <div class="right-sidebar item">
                                ...
                                <form method="post" class="right-sidebar item-form contact__form" action="https://duruthemes.com/demo/html/travol/multipage-slider/mail.php">
                                    <!-- form message -->
                                    <div class="row">
                                        <div class="col-12">
